...
export default class HomePage extends React.PureComponent {
  ...
  fetch = () => {
    ...
    return get('/api/serials')
      ...
      .then(() => get('/api/config'))
      .then(config => {
        const selectedSkin = find(config.skins.options, {
          id: config.skins.selected,
        }) || {
          buttons: [],
        };
        this.setState({
          config,
          originalSelectedSkin: selectedSkin,
          selectedSkin,
          isLoading: false,
        });
      })
  ...
  save = () => {
    ...
    const options = filter(
      config.skins.options,
      option => option.id !== selectedSkin.id,
    );
            ...
            <form className="button-control-panel">
                  ...
                  <div className="dropdown">
                    ...
                    >
                      <a
                        ...
                        href="#"
                        onClick={() =>
                          this.handleButtonChange(selectedButtonIndex)({
                            type: 'round',
                          })
                        }
                      >
              ...
              <div className="form-group row">
                ...
                <div className="col-sm-9">
                  <input
                    onChange={event =>
                      this.handleButtonStyleChange(selectedButtonIndex)({
                        width: `${event.target.value}px`,
                      })
                    }
                    type="number"
                    className="form-control"
                    value={parseInt(selectedButton.style.width)}
                  />
                </div>
              </div>
              <div className="form-group row">
                ...
                <div className="col-sm-9">
                  <input
                    ...
                    type="number"
                    className="form-control"
                    value={parseInt(selectedButton.style.height)}
                  />
                </div>
              </div>
              <div className="form-group row">
